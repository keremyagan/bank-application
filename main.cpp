		...
		if(option==2){
			...
			if(is_true==true){
				...
				for(int k=0;k<1;k++){
					...
					cout<<"5-Account Details"<<endl<<"6-Change Password"<<endl<<"7-Exit"<<endl<<"Please Enter Transaction Number:";
					int option_1;
					cin>>option_1;
					...
					if(option_1==3){//remittance eft
						...
						string file_name=to_string+file_extention; //file name is user's id no because it's unique
						SignUp user2;
